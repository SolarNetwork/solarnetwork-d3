 ...
 */
  sn.chart.baseGroupedSeasonalLineChart = function(containerSelector, chartConfig) {
    var parent = sn.chart.baseGroupedTimeChart(containerSelector, chartConfig), superDraw = sn.superMethod.call(parent, "draw");
 ...
 */
  sn.chart.powerAreaChart = function(containerSelector, chartConfig) {
    var parent = sn.chart.baseGroupedStackTimeChart(containerSelector, chartConfig), superDraw = sn.superMethod.call(parent, "draw");
    var self = function() {
      var me = sn.util.copy(parent);
      return me;
    }();
